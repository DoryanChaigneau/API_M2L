!function () {
    if ("ontouchstart" in window) {
        ...
        e = function (e, t) {
            ...
            var t = Date.now(), n = t - s.time, r = e.clientX, i = e.clientY,
                a = [Math.abs(s.x - r), Math.abs(s.y - i)], c = o(e.target, "A") || e.target, l = c.nodeName,
                u = "A" === l, d = window.navigator.standalone && u && e.target.getAttribute("href");
    ...
    function M(e, t, n) {
        var r, i, o, s, a, c, l, u, d = this, f = {}, p = e.style, h = e.nodeType && ke(e), g = ve.get(e, "fxshow");
        ...
        if (G.isEmptyObject(f)) "inline" === ("none" === l ? w(e.nodeName) : l) && (p.display = l); else {
    ...
    function q(e, t) {
        var n, r, i, o, s;
        for (n in e) if (r = G.camelCase(n), i = t[r], o = e[n], G.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), s = G.cssHooks[r], s && "expand" in s) {
    ...
    function $(e, t, n) {
        var r, i, o = 0, s = tt.length, a = G.Deferred().always(function () {
            delete c.elem
        }), c = function () {
            if (i) return !1;
    ...
    function I(e, t, n, r) {
        ...
        for (o = u.shift(); o;) if (e.responseFields[o] && (n[e.responseFields[o]] = t), !c && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)), c = o, o = u.shift()) if ("*" === o) o = c; else if ("*" !== c && c !== o) {
            if (s = l[c + " " + o] || l["* " + o], !s) for (i in l) if (a = i.split(" "), a[1] === o && (s = l[c + " " + a[0]] || l["* " + a[0]])) {
            ...
            if (s !== !0) if (s && e["throws"]) t = s(t); else try {
                ...
                return {state: "parsererror", error: s ? d : "No conversion from " + c + " to " + o}
            }
        }
    ...
    function H(e, t, n, r) {
        ...
        }); else if (n || "object" !== G.type(t)) r(e, t); else for (i in t) H(e + "[" + i + "]", t[i], n, r)
    }
    ...
    var P = [], z = P.slice, W = P.concat, U = P.push, Q = P.indexOf, V = {}, X = V.toString, K = V.hasOwnProperty,
        Z = {}, Y = e.document, J = "2.1.3", G = function (e, t) {
    ...
    G.fn = G.prototype = {
        ...
        }, push: U, sort: P.sort, splice: P.splice
        ...
        expando: "jQuery" + (J + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var i, o = 0, s = e.length, a = n(e), c = [];
            if (a) for (; s > o; o++) i = t(e[o], o, r), null != i && c.push(i); else for (o in e) i = t(e[o], o, r), null != i && c.push(i);
            return W.apply([], c)
    ...
    var ie = function (e) {
        ...
        function v(e, t, n, i, o, s) {
            return i && !i[I] && (i = v(i)), o && !o[I] && (o = v(o, s)), r(function (r, s, a, c) {
                var l, u, d, f = [], p = [], h = s.length, v = r || g(t || "*", a.nodeType ? [a] : a, []),
                    y = !e || !r && t ? v : m(v, f, e, a, c), b = n ? o || (r ? e : h || i) ? [] : s : y;
        ...
        function y(e) {
            for (var t, n, r, i = e.length, o = _.relative[e[0].type], s = o || _.relative[" "], a = o ? 1 : 0, c = p(function (e) {
                ...
                return t = null, i
            }]; i > a; a++) if (n = _.relative[e[a].type]) u = [p(h(u), n)]; else {
                if (n = _.filter[e[a].type].apply(null, e[a].matches), n[I]) {
                    for (r = ++a; i > r && !_.relative[e[r].type]; r++) ;
                    return v(a > 1 && h(u), a > 1 && f(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(ce, "$1"), n, r > a && y(e.slice(a, r)), i > r && y(e = e.slice(r)), i > r && f(e))
                }
                u.push(n)
            }
            return h(u)
        ...
        function b(e, n) {
            var i = n.length > 0, o = e.length > 0, s = function (r, s, a, c, l) {
                var u, d, f, p = 0, h = "0", g = r && [], v = [], y = T, b = r || o && _.find.TAG("*", l),
        ...
        var w, x, _, k, C, N, E, S, T, A, L, j, M, q, $, O, R, D, B, I = "sizzle" + 1 * new Date, H = e.document, F = 0,
            P = 0, z = n(), W = n(), U = n(), Q = function (e, t) {
                return e === t && (L = !0), 0
            }, V = 1 << 31, X = {}.hasOwnProperty, K = [], Z = K.pop, Y = K.push, J = K.push, G = K.slice,
            ee = function (e, t) {
            ...
            se = ":(" + re + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + oe + ")*)|.*)\\)|)",
            ae = new RegExp(ne + "+", "g"), ce = new RegExp("^" + ne + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ne + "+$", "g"),
            le = new RegExp("^" + ne + "*," + ne + "*"), ue = new RegExp("^" + ne + "*([>+~]|" + ne + ")" + ne + "*"),
            de = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]", "g"), fe = new RegExp(se),
            pe = new RegExp("^" + ie + "$"), he = {
                ID: new RegExp("^#(" + re + ")"),
                CLASS: new RegExp("^\\.(" + re + ")"),
            ...
            ye = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, be = /[+~]/, we = /'|\\/g,
            xe = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)", "ig"), _e = function (e, t, n) {
                var r = "0x" + t - 65536;
        ...
        x = t.support = {}, C = t.isXML = function (e) {
            ...
            return r !== M && 9 === r.nodeType && r.documentElement ? (M = r, q = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", ke, !1) : n.attachEvent && n.attachEvent("onunload", ke)), $ = !C(r), x.attributes = i(function (e) {
                ...
                if (e === t) return L = !0, 0;
                var n, i = 0, o = e.parentNode, a = t.parentNode, c = [e], l = [t];
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        var l, u, d, f, p, h, g = o !== s ? "nextSibling" : "previousSibling", m = t.parentNode,
                            v = a && t.nodeName.toLowerCase(), y = !c && !a;
                        if (m) {
                            if (o) {
                                for (; g;) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                for (u = m[I] || (m[I] = {}), l = u[e] || [], p = l[0] === F && l[1], f = l[0] === F && l[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (f = p = 0) || h.pop();) if (1 === d.nodeType && ++f && d === t) {
                                    u[e] = [F, p, f];
                                    break
                                }
                            } else if (y && (l = (t[I] || (t[I] = {}))[e]) && l[0] === F) f = l[1]; else for (; (d = ++p && d && d[g] || (f = p = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[I] || (d[I] = {}))[e] = [F, f]), d !== t));) ;
            ...
            pseudos: {
                not: r(function (e) {
                    ...
                    return e = e.replace(xe, _e), function (t) {
        ...
        return d.prototype = _.filters = _.pseudos, _.setFilters = new d, N = t.tokenize = function (e, n) {
            ...
            var i, o, s, a, c, l = "function" == typeof e && e, d = !r && N(e = l.selector || e);
            if (n = n || [], 1 === d.length) {
                ...
                for (i = he.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !_.relative[a = s.type]);) if ((c = _.find[a]) && (r = c(s.matches[0].replace(xe, _e), be.test(o[0].type) && u(t.parentNode) || t))) {
    ...
    var oe = G.expr.match.needsContext, se = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, ae = /^.[^:#\[\.,]*$/;
    ...
    var ce, le = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ue = G.fn.init = function (e, t) {
        var n, r;
        if (!e) return this;
        if ("string" == typeof e) {
    ...
    G.extend({
        ...
        has: function (e) {
            ...
            for (var n, r = 0, i = this.length, o = [], s = oe.test(e) || "string" != typeof e ? G(e, t || this.context) : 0; i > r; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && G.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
    ...
    G.Callbacks = function (e) {
        ...
        var t, n, r, i, s, a, c = [], l = !e.once && [], u = function (o) {
            for (t = e.memory && o, n = !0, a = i || 0, i = 0, s = c.length, r = !0; c && s > a; a++) if (c[a].apply(o[0], o[1]) === !1 && e.stopOnFalse) {
                t = !1;
                break
            }
        ...
        Deferred: function (e) {
            ...
            var t, n, r, i = 0, o = z.call(arguments), s = o.length,
                a = 1 !== s || e && G.isFunction(e.promise) ? s : 0, c = 1 === a ? e : G.Deferred(),
                l = function (e, n, r) {
                    return function (i) {
    ...
    var me = G.access = function (e, t, n, r, i, o, s) {
        ...
        if ("object" === G.type(n)) {
            ...
            return l.call(G(e), n)
        })), t)) for (; c > a; a++) t(e[a], n, s ? r : r.call(e[a], a, t(e[a], n)));
    ...
    G.acceptData = function (e) {
        ...
        key: function (e) {
            ...
            if ("string" == typeof t) o[t] = n; else if (G.isEmptyObject(o)) G.extend(this.cache[i], t); else for (r in t) o[r] = t[r];
            return o
        }, get: function (e, t) {
    ...
    G.extend({
        ...
        queue: function (e, t, n) {
            ...
            t = t || "fx";
            var n = G.queue(e, t), r = n.length, i = n.shift(), o = G._queueHooks(e, t), s = function () {
                G.dequeue(e, t)
            };
        ...
        queue: function (e, t) {
            ...
            var n, r = 1, i = G.Deferred(), o = this, s = this.length, a = function () {
                --r || i.resolveWith(o, [o])
            };
    ...
    var xe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, _e = ["Top", "Right", "Bottom", "Left"],
        ke = function (e, t) {
    ...
    var Ee = /^key/, Se = /^(?:mouse|pointer|contextmenu)|click/, Te = /^(?:focusinfocus|focusoutblur)$/,
        Ae = /^([^.]*)(?:\.(.+)|)$/;
    G.event = {
        global: {},
        add: function (e, t, n, r, i) {
            var o, s, a, c, l, u, d, f, p, h, g, m = ve.get(e);
            if (m) for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = G.guid++), (c = m.events) || (c = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (m && (c = m.events)) {
                for (t = (t || "").match(pe) || [""], l = t.length; l--;) if (a = Ae.exec(t[l]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p) {
        ...
        trigger: function (t, n, r, i) {
            var o, s, a, c, l, u, d, f = [r || Y], p = K.call(t, "type") ? t.type : t,
        ...
        dispatch: function (e) {
            e = G.event.fix(e);
            var t, n, r, i, o, s = [], a = z.call(arguments), c = (ve.get(this, "events") || {})[e.type] || [],
        ...
        simulate: function (e, t, n, r) {
            var i = G.extend(new G.Event, n, {type: e, isSimulated: !0, originalEvent: {}});
        ...
        on: function (e, t, n, r, i) {
            ...
            if (null == n && null == r ? (r = t, n = t = void 0) : null == r && ("string" == typeof t ? (r = n, n = void 0) : (r = n, n = t, t = void 0)), r === !1) r = u; else if (!r) return this;
    ...
    var Le = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, je = /<([\w:]+)/,
        Me = /<|&#?\w+;/, qe = /<(?:script|style|link)/i, $e = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Oe = /^$|\/(?:java|ecma)script/i, Re = /^true\/(.*)/, De = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Be = {
    ...
    Be.optgroup = Be.option, Be.tbody = Be.tfoot = Be.colgroup = Be.caption = Be.thead, Be.th = Be.td, G.extend({
        clone: function (e, t, n) {
            var r, i, o, s, a = e.cloneNode(!0), c = G.contains(e.ownerDocument, e);
            ...
            for (var i, o, s, a, c, l, u = t.createDocumentFragment(), d = [], f = 0, p = e.length; p > f; f++) if (i = e[f], i || 0 === i) if ("object" === G.type(i)) G.merge(d, i.nodeType ? [i] : i); else if (Me.test(i)) {
        ...
        text: function (e) {
            ...
            e = W.apply([], e);
            var n, r, i, o, s, a, c = 0, l = this.length, u = this, d = l - 1, f = e[0], g = G.isFunction(f);
    ...
    var Ie, He = {}, Fe = /^margin/, Pe = new RegExp("^(" + xe + ")(?!px)[a-z%]+$", "i"), ze = function (t) {
    ...
    var We = /^(none|table(?!-c[ea]).+)/, Ue = new RegExp("^(" + xe + ")(.*)$", "i"),
        Qe = new RegExp("^([+-])=(" + xe + ")", "i"),
        Ve = {position: "absolute", visibility: "hidden", display: "block"},
        Xe = {letterSpacing: "0", fontWeight: "400"}, Ke = ["Webkit", "O", "Moz", "ms"];
    G.extend({
        cssHooks: {
            opacity: {
                get: function (e, t) {
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = G.camelCase(t), c = e.style;
        ...
        constructor: T, init: function (e, t, n, r, i, o) {
    ...
    var Ze, Ye, Je = /^(?:toggle|show|hide)$/, Ge = new RegExp("^(?:([+-])=|)(" + xe + ")([a-z%]*)$", "i"),
        et = /queueHooks$/, tt = [M], nt = {
            "*": [function (e, t) {
                var n = this.createTween(e, t), r = n.cur(), i = Ge.exec(t), o = i && i[3] || (G.cssNumber[e] ? "" : "px"),
                    s = (G.cssNumber[e] || "px" !== o && +r) && Ge.exec(G.css(n.elem, e)), a = 1, c = 20;
                if (s && s[3] !== o) {
                    o = o || s[3], i = i || [], s = +r || 1;
    ...
    G.Animation = G.extend($, {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            var i = G.isEmptyObject(e), o = G.speed(t, n, r), s = function () {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                var t = !0, i = null != e && e + "queueHooks", o = G.timers, s = ve.get(this);
            ...
            return e !== !1 && (e = e || "fx"), this.each(function () {
                var t, n = ve.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = G.timers,
                    s = r ? r.length : 0;
    ...
    G.fn.extend({
        addClass: function (e) {
            var t, n, r, i, o, s, a = "string" == typeof e && e, c = 0, l = this.length;
            if (G.isFunction(e)) return this.each(function (t) {
                G(this).addClass(e.call(this, t, this.className))
            });
            if (a) for (t = (e || "").match(pe) || []; l > c; c++) if (n = this[c], r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(at, " ") : " ")) {
                for (o = 0; i = t[o++];) r.indexOf(" " + i + " ") < 0 && (r += i + " ");
                s = G.trim(r), n.className !== s && (n.className = s)
            }
            return this
        }, removeClass: function (e) {
            var t, n, r, i, o, s, a = 0 === arguments.length || "string" == typeof e && e, c = 0, l = this.length;
            if (G.isFunction(e)) return this.each(function (t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(G.isFunction(e) ? function (n) {
                ...
                if ("string" === n) for (var t, r = 0, i = G(this), o = e.match(pe) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else (n === Ne || "boolean" === n) && (this.className && ve.set(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : ve.get(this, "__className__") || "")
            })
        }, hasClass: function (e) {
    ...
    G.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, s = o ? null : [], a = o ? i + 1 : r.length, c = 0 > i ? a : o ? i : 0; a > c; c++) if (n = r[c], !(!n.selected && c !== i || (Z.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && G.nodeName(n.parentNode, "optgroup"))) {
    ...
    var dt = /#.*$/, ft = /([?&])_=[^&]*/, pt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        ...
        vt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, yt = {}, bt = {}, wt = "*/".concat("*"),
        xt = e.location.href, _t = vt.exec(xt.toLowerCase()) || [];
    G.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function (e, t) {
            ...
            var r, i, o, s, a, c, l, u, d = G.ajaxSetup({}, t), f = d.context || d,
                p = d.context && (f.nodeType || f.jquery) ? G(f) : G.event, h = G.Deferred(),
                g = G.Callbacks("once memory"), m = d.statusCode || {}, v = {}, y = {}, b = 0, w = "canceled", x = {
    ...
    var Tt = 0, At = {}, Lt = {0: 200, 1223: 204}, jt = G.ajaxSettings.xhr();
    ...
    G.offset = {
        setOffset: function (e, t, n) {
            var r, i, o, s, a, c, l, u = G.css(e, "position"), d = G(e), f = {};
    ...
    var l = e.jQuery, u = e.console, d = void 0 !== u, f = Object.prototype.toString;
    ...
    function u(e, n, i, o) {
        ...
        function p(e, t, n, r) {
            var i = r ? "" : x.classPrefix, o = '<span class="' + i, s = n ? "" : "</span>";
            return o += e + '">', o + t + s
        }
    ...
    function h(e) {
        ...
        if (!i(t)) {
            ...
            var r = n.textContent, s = t ? u(t, r, !0) : d(r), l = a(n);
            if (l.length) {
    ...
    var x = {classPrefix: "hljs-", tabReplace: null, useBR: !1, languages: void 0}, _ = {}, k = {};
    return e.highlight = u, e.highlightAuto = d, e.fixMarkup = f, e.highlightBlock = h, e.configure = g, e.initHighlighting = m, e.initHighlightingOnLoad = v, e.registerLanguage = y, e.listLanguages = b, e.getLanguage = w, e.inherit = s, e.IR = "[a-zA-Z]\\w*", e.UIR = "[a-zA-Z_]\\w*", e.NR = "\\b\\d+(\\.\\d+)?", e.CNR = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", e.BNR = "\\b(0b[01]+)", e.RSR = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", e.BE = {
        ...
        r.c = i;
        var o = e.inherit(e.TM, {b: n}), s = "(\\(.*\\))?\\s*\\B[-=]>",
            a = {cN: "params", b: "\\([^\\(]", rB: !0, c: [{b: /\(/, e: /\)/, k: t, c: ["self"].concat(i)}]};
        return {
            ...
            c: i.concat([e.C("###", "###"), e.HCM, {
                ...
                rB: !0,
                c: [o, a]
            }, {b: /[:\(,=]\s*/, r: 0, c: [{cN: "function", b: s, e: "[-=]>", rB: !0, c: [a]}]}, {
                cN: "class",
                bK: "class",
                e: "$",
                i: /[:="\[\]]/,
        ...
        var t = {cN: "keyword", b: "\\b[a-z\\d_]*_t\\b"}, n = {
            ...
            c: [{b: /\\\n/, r: 0}, {
                ...
                c: [e.inherit(n, {cN: "meta-string"}), {cN: "meta-string", b: "<", e: ">", i: "\\n"}]
            }, n, e.CLCM, e.CBCM]
        }, o = e.IR + "\\s*\\(", s = {
        ...
        var t = {cN: "built_in", b: "(AV|CA|CF|CG|CI|MK|MP|NS|UI|XC)\\w+"}, n = {
        ...
        var t = "getpwent getservent quotemeta msgrcv scalar kill dbmclose undef lc ma syswrite tr send umask sysopen shmwrite vec qx utime local oct semctl localtime readpipe do return format read sprintf dbmopen pop getpgrp not getpwnam rewinddir qqfileno qw endprotoent wait sethostent bless s|0 opendir continue each sleep endgrent shutdown dump chomp connect getsockname die socketpair close flock exists index shmgetsub for endpwent redo lstat msgctl setpgrp abs exit select print ref gethostbyaddr unshift fcntl syscall goto getnetbyaddr join gmtime symlink semget splice x|0 getpeername recv log setsockopt cos last reverse gethostbyname getgrnam study formline endhostent times chop length gethostent getnetent pack getprotoent getservbyname rand mkdir pos chmod y|0 substr endnetent printf next open msgsnd readdir use unlink getsockopt getpriority rindex wantarray hex system getservbyport endservent int chr untie rmdir prototype tell listen fork shmread ucfirst setprotoent else sysseek link getgrgid shmctl waitpid unpack getnetbyname reset chdir grep split require caller lcfirst until warn while values shift telldir getpwuid my getprotobynumber delete and sort uc defined srand accept package seekdir getprotobyname semop our rename seek if q|0 chroot sysread setpwent no crypt getc chown sqrt write setnetent setpriority foreach tie sin msgget map stat getlogin unless elsif truncate exec keys glob tied closedirioctl socket readlink eval xor readline binmode setservent eof ord bind alarm pipe atan2 getgrent exp time push setgrent gt lt or ne m|0 break given say state when",
            n = {cN: "subst", b: "[$@]\\{", e: "\\}", k: t}, r = {b: "->{", e: "}"},
            i = {v: [{b: /\$\d/}, {b: /[\$%@](\^\w\b|#\w+(::\w+)*|{\w+}|\w+(::\w*)*)/}, {b: /[\$%@][^\s\w{]/, r: 0}]},
            o = [e.BE, n, i], s = [i, e.HCM, e.C("^\\=\\w", "\\=cut", {eW: !0}), r, {
                cN: "string",
                c: o,
        ...
        var t = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",
            ...
            }, c = {cN: "params", b: "\\(", e: "\\)", endsParent: !0, k: n}, l = [a, i, {
                cN: "class",
                bK: "class module",
                e: "$|;",
                i: /=/,
    ...
    e.cleanData = function (t) {
        ...
        e.fn[t] = function (o) {
            var s = "string" == typeof o, a = n.call(arguments, 1), c = this;
        ...
        option: function (t, n) {
            ...
            if ("string" == typeof t) if (s = {}, r = t.split("."), t = r.shift(), r.length) {
        ...
        _on: function (t, n, r) {
            ...
            "boolean" != typeof t && (r = n, n = t, t = !1), r ? (n = i = e(n), this.bindings = this.bindings.add(n)) : (r = n, n = this.element, i = this.widget()), e.each(r, function (r, s) {
                ...
                var c = r.match(/^([\w:-]*)\s*(.*)$/), l = c[1] + o.eventNamespace, u = c[2];
        ...
        e.Widget.prototype["_" + t] = function (r, i, o) {
            ...
            i = i || {}, "number" == typeof i && (i = {duration: i}), s = !e.isEmptyObject(i), i.complete = o, i.delay && r.delay(i.delay), s && e.effects && e.effects.effect[a] ? r[t](i) : a !== t && r[a] ? r[a](i.duration, i.easing, o) : r.queue(function (n) {
    ...
    "use strict";
    var i = "tocify", o = "tocify-focus", s = "tocify-hover", a = "tocify-hide", c = "tocify-header", l = "." + c,
        u = "tocify-subheader", d = "." + u, f = "tocify-item", p = "." + f, h = "tocify-extend-page", g = "." + h;
    e.widget("toc.tocify", {
        version: "1.8.0",
        options: {
            context: "body",
        ...
        _generateToc: function () {
            var t, n, r = this, o = r.options.ignoreSelector;
        ...
        _setActiveElement: function (e) {
            var n = this, r = t.location.hash.substring(1), i = n.element.find("li[data-unique='" + r + "']");
        ...
        _nestElements: function (t, n) {
            ...
            return r = e.grep(this.items, function (e) {
                ...
                "class": f,
                "data-unique": o
            }).append(e("<a/>", {text: t.text()})), t.before(e("<div/>", {name: o, "data-unique": o})), i
        },
        _generateHashValue: function (e, t, n) {
            var r = "", i = this.options.hashGenerator;
            if ("pretty" === i) {
        ...
        _appendSubheaders: function (t, n) {
            var r = e(this).index(t.options.selectors), i = e(t.options.selectors).eq(r - 1),
                o = +e(this).prop("tagName").charAt(1), s = +i.prop("tagName").charAt(1);
        ...
        _setEventHandlers: function () {
            ...
            this.element.on("click.tocify", "li", function (n) {
                ...
                e("html, body").promise().done(function () {
                    var o, s, a, c, l = e(t).scrollTop(), u = e(t).height(), d = e(n).height(),
                    ...
                    setTimeout(function () {
                        ...
                        if (i.cachedAnchors.each(function (e) {
                            ...
                            var l = i.tocifyWrapper, u = e(o).closest(".tocify-header"), d = u.offset().top,
                                f = l.offset().top, p = d - f;
                            if (p >= e(t).height()) {
                                var h = p + l.scrollTop();
                                l.scrollTop(h)
        ...
        _scrollTo: function (t) {
            var n = this, r = n.options.smoothScroll || 0, i = n.options.scrollTo;
            return e("html, body").promise().done(function () {
                e("html, body").animate({scrollTop: e('div[data-unique="' + t.attr("data-unique") + '"]').next().offset().top - (e.isFunction(i) ? i.call() : i) + "px"}, {duration: r})
            }), n
        }
    })
}), function () {
    ...
    e.version = "0.5.7", e.utils = {}, e.utils.warn = function (e) {
        ...
        var r = {}, i = new e.SortedSet, o = t[this._ref], n = void 0 === n ? !0 : n;
        ...
        for (var s = 0; s < i.length; s++) {
            var a = i.elements[s], c = this._fields.reduce(function (e, t) {
        ...
        var n = e[this._ref], t = void 0 === t ? !0 : t;
        ...
        var n = this.pipeline.run(e.tokenizer(t)), r = new e.Vector, i = [], o = this._fields.reduce(function (e, t) {
            return e + t.boost
        }, 0), s = n.some(function (e) {
            return this.tokenStore.has(e)
        }, this);
        if (!s) return [];
        n.forEach(function (t, n, s) {
            var a = 1 / s.length * this._fields.length * o, c = this,
                l = this.tokenStore.expand(t).reduce(function (n, i) {
                    var o = c.corpusTokens.indexOf(i), s = c.idf(i), l = 1, u = new e.SortedSet;
                    if (i !== t) {
        ...
        for (var n = this.documentStore.get(t), r = n.length, i = new e.Vector, o = 0; r > o; o++) {
            var s = n.elements[o], a = this.tokenStore.get(s)[t].tf, c = this.idf(s);
        ...
        var e = {
            ...
            r = "[aeiouy]", i = n + "[^aeiouy]*", o = r + "[aeiou]*", s = "^(" + i + ")?" + o + i,
            a = "^(" + i + ")?" + o + i + "(" + o + ")?$", c = "^(" + i + ")?" + o + i + o + i, l = "^(" + i + ")?" + r,
            u = new RegExp(s), d = new RegExp(c), f = new RegExp(a), p = new RegExp(l), h = /^(.+?)(ss|i)es$/,
            g = /^(.+?)([^s])s$/, m = /^(.+?)eed$/, v = /^(.+?)(ed|ing)$/, y = /.$/, b = /(at|bl|iz)$/,
            w = new RegExp("([^aeiouylsz])\\1$"), x = new RegExp("^" + i + r + "[^aeiouwxy]$"), _ = /^(.+?[^aeiou])y$/,
            ...
            E = /^(.+?)(s|t)(ion)$/, S = /^(.+?)e$/, T = /ll$/, A = new RegExp("^" + i + r + "[^aeiouwxy]$"),
            L = function (n) {
                var r, i, o, s, a, c, l;
    ...
    var o, s, a = {element: "span", className: "search-highlight"}, c = new lunr.Index;
